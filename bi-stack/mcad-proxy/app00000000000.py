...
async def mcad_session_new(req: Request):
    ...
    session_resp = _relay_post("/sessions/create", {
...
async def mcad_session_resume(req: Request):
    ...
    try:
        ...
        return JSONResponse({"ok": False, "error": f"Session not found: {e}"}, status_code=404)
...
def mcad_history_current():
    ...
    try:
        ...
        return JSONResponse(
            {"ok": False, "session_id": sid, "objective_id": oid, "error": str(e), "items": []},
            status_code=500,
        )
